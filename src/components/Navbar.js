...
const Navbar = ({ children }) => {
    const menuItems = <>
      ...
      <li className="dropdown dropdown-hover dropdown-end">
        <label tabindex="0" className="btn btn-primary m-1 rounded-lg btn-outline">Dropdown</label>
    ...
    return (
        <div className="drawer drawer-end mt-16">
            ...
            <div className="drawer-content flex flex-col">
                ...
                <div className="flex-1 px-2 mx-2 text-2xl">Clean Pro</div>
